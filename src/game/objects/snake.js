import { Group, BoxGeometry, MeshLambertMaterial, Mesh, Vector3, DoubleSide, DodecahedronGeometry, PointLight, ConeGeometry, CanvasTexture, RepeatWrapping } from "three";
...
export default class Snake extends Group {
    constructor(props) {
        ...
        // Create patterned texture for snake
        this.snakeTexture = this.createSnakePattern();
    ...
    createSnakePattern() {
        ...
        // Add black stripes/scales pattern - larger squares
